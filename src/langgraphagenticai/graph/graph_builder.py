...
from src.langgraphagenticai.tools.search_tool import get_tavily_tool,create_tool_node
from src.langgraphagenticai.nodes.basic_chatbot_node import BasicChatbotNode
from src.langgraphagenticai.nodes.chatbot_with_tool_node import ChatbotWithToolNode
from langgraph.prebuilt import tools_condition
from langgraph.graph import START, END
from src.langgraphagenticai.nodes.ai_news_nodes import AINewsNode
...
class GraphBuilder:
    ...
    def chatbot_with_tools_build_graph(self):
        """
        Builds a advance chatbot graph with took integration using LangGraph.
